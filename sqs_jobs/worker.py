    ...
    try:
        ...
        if timeout:
            ...
            def timeout_handler(signum, frame):
                raise TimeoutError(
                    f"Job {job.job_id} timed out after {timeout} seconds"
                )
        ...
        try:
            ...
            if result_backend:
                ...
                print(result_backend.get(job.job_id))  # For debugging purposes
...
class Worker:
        ...
        for message in messages:
            ...
            try:
                ...
                future = self._executor.submit(
                    _execute_job_with_timeout, job_data, timeout, self.result_backend
                )
    ...
    def _check_completed_jobs(self) -> None:
        ...
        for future in as_completed(self._active_jobs.keys()):
    ...
    def shutdown(self) -> None:
        ...
        if self._executor and self._active_jobs:
            ...
            if self._active_jobs:
                logger.warning(
                    f"Forcibly terminating {len(self._active_jobs)} remaining jobs"
                )
